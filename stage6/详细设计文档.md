...
<table>
	...
	<tr>
		...
		<th>库存数据层的对象模型，拥有判断库存时间，得到当前库存信息，得到库存商品明细，创建商品报损单并储存记录，提交商品报损单，减少库存数量并存储，提交报损单，提交报溢单，提交报溢单并存储记录的功能。</th>
	</tr>
	</table>
<br>
<br>
...
<tr>
		...
		<tr>
			<th>后置条件</th>
			<th>数据库保存提交报损单记录，并且把序列化文件保存到本地</th>
</tr>	
<tr>
