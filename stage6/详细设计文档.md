...
如图4.1.1-5表明了企业进销存系统中，当库存管理人员查看商品分类后，显示商品分类下商品业务逻辑处理相关对象之间的协作。![](pictures/classify/classify_get.png)
图4.1.1-5 查看商品分类下商品的顺序图 
...
&nbsp;&nbsp;&nbsp;&nbsp; presentListbl的模块设计见图4.1.4-1.![](pictures/presentList/presentList1.png)
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th> presentListBLService.addPresentList(PresentListVO vo);</th>
...
<br>
（4)业务逻辑层的动态模型
如图4.1.3-1表明了企业进销存系统中，当库存管理人员增加商品赠送单后，增加商品赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/add.png)

图4.1.4-1增加商品赠送单的顺序图 

如图4.1.4-2表明了企业进销存系统中，当库存管理人员去除商品赠送单后，商品赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/delete.png)
图4.1.4-2 删除赠送单的顺序图 


如图4.1.4-3表明了企业进销存系统中，当库存管理人更新赠送单后，赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/update.png)
图4.1.4-3 更新赠送的顺序图 

如图4.1.4-4表明了企业进销存系统中，当查找赠送单，赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/get.png)
图4.1.4-4 查找赠送单的顺序图 

如图4.1.4-4表明了企业进销存系统中，当生成赠送单红冲，赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/addRed.png)
图4.1.4-4 赠送单红冲的顺序图 

如图4.1.4-4表明了企业进销存系统中，当查询所有赠送单，赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/getAll.png)
图4.1.4-4 得到所有赠送单的顺序图 

如图4.1.1-5描述了presentList对象在生存时的状态序列，在经过并且在结束操作商品分类后结束生命
...
&nbsp;&nbsp;&nbsp;&nbsp; lackListbl的模块设计见图4.1.4-1。![](pictures/lackList/lackList1.png)
...
<br>
（4)业务逻辑层的动态模型报损
如图4.1.3-1表明了企业进销存系统中，当库存管理人员增加商品报损单后，增加商品报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/add.png)
图4.1.4-1增加商品报损单的顺序图
如图4.1.4-2表明了企业进销存系统中，当库存管理人员去除商品报损单后，商品报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/delete.png)
图4.1.4-2 删除报损单的顺序图 
如图4.1.4-3表明了企业进销存系统中，当库存管理人更新报损单后，报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/update.png)
图4.1.4-3 更新报损的顺序图 
如图4.1.4-4表明了企业进销存系统中，当查找报损单，报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/get.png)
图4.1.4-4 查找报损单的顺序图 
如图4.1.4-4表明了企业进销存系统中，当生成报损单红冲，报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/addRed.png)
图4.1.4-4 报损单红冲的顺序图 
如图4.1.4-4表明了企业进销存系统中，当查询所有报损单，报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/getAll.png)
图4.1.4-4 得到所有报损单的顺序图 
如图4.1.1-5描述了lackList对象在生存时的状态序列，在经过并且在结束操作商品分类后结束生命
![](pictures/presentList/presentList_statement.png)
...
![](pictures/overflowList/overflowList1.png)
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th> overflowListBLService.addoverflowList(overflowListVO vo);</th>
...
<br>
<br>（4)业务逻辑层的动态模型
如图4.1.3-1表明了企业进销存系统中，当库存管理人员增加商品赠送单后，增加商品赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/add.png)

图4.1.4-1增加商品赠送单的顺序图 

如图4.1.4-2表明了企业进销存系统中，当库存管理人员去除商品赠送单后，商品赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/delete.png)
图4.1.4-2 删除赠送单的顺序图 


如图4.1.4-3表明了企业进销存系统中，当库存管理人更新赠送单后，赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/update.png)
图4.1.4-3 更新赠送的顺序图 

如图4.1.4-4表明了企业进销存系统中，当查找赠送单，赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/get.png)
图4.1.4-4 查找赠送单的顺序图 

如图4.1.4-4表明了企业进销存系统中，当生成赠送单红冲，赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/addRed.png)
图4.1.4-4 赠送单红冲的顺序图 

如图4.1.4-4表明了企业进销存系统中，当查询所有赠送单，赠送单业务逻辑处理相关对象之间的协作。![](pictures/overflowList/getAll.png)
图4.1.4-4 得到所有赠送单的顺序图 

如图4.1.1-5描述了overflowList对象在生存时的状态序列，在经过并且在结束操作商品分类后结束生命
![](pictures/overflowList/overflowList_statement.png)
...
<tr><th>Stock.stockCom(overflowListPO po, ArrayList&lt;StockPO> receipt);</th>
...
<br>（2）整体结构
根据体系结构的设计，采用分层风格，将系统分为展示层，业务逻辑层，数据层。每一层之间为了灵活性，添加了接口，以实现针对接口编程，隔离数据传输的职责，降低层与层之间耦合，添加的接口是presentListDataService 接口。PresentListPO是做为管理信息的持久化对象被添加到设计模型中的。
...
<table>
	...
	<tr>
		...
		<th>赠送单的对象模型，拥有得到单据时间，提交赠送单据，查找赠送单据，生成赠送单据，得到反馈信息的功能。</th>
	</tr>
	</table>
<br>
<br>
...
##4.2.4lackListData模块
(1）模块概述
lackListData模块承担的需求参见需求规格说明文档功能需求及相关功能需求。
lackListData模块的职责及接口参见软件体系结构描述文档。
<br>（2）整体结构
根据体系结构的设计，采用分层风格，将系统分为展示层，业务逻辑层，数据层。每一层之间为了灵活性，添加了接口，以实现针对接口编程，隔离数据传输的职责，降低层与层之间耦合，添加的接口是lackListDataService 接口。lackListPO是做为管理信息的持久化对象被添加到设计模型中的。
lackListData模块的设计如图4.2.1-3所示. 
![](pictures/lackList/lackList_data.png)
<br>
<br>
<br>
<table>
	...
	<tr>
		<th>lackListData</th>
		<th>报损单的对象模型，拥有得到单据时间，提交报损单据，查找报损单据，生成报损单据，得到反馈信息的功能。</th>
	</tr>
	</table>
<br>
<br>
...
##4.2.5overflowListData模块
(1）模块概述
overflowListData模块承担的需求参见需求规格说明文档功能需求及相关功能需求。
overflowListData模块的职责及接口参见软件体系结构描述文档。
<br>（2）整体结构
根据体系结构的设计，采用分层风格，将系统分为展示层，业务逻辑层，数据层。每一层之间为了灵活性，添加了接口，以实现针对接口编程，隔离数据传输的职责，降低层与层之间耦合，添加的接口是overflowListDataService 接口。overflowListPO是做为管理信息的持久化对象被添加到设计模型中的。
overflowListData模块的设计如图4.2.1-3所示. 
![](pictures/overflowList/overflowList_data.png)
<br>
<br>
<br>
<table>
	...
	<tr>
		<th>overflowListData</th>
		<th>报溢单的对象模型，拥有得到单据时间，提交报溢单据，查找报溢单据，生成报溢单据，得到反馈信息的功能。</th>
	</tr>
	</table>
<br>
<br>
