...
<br>
（4)业务逻辑层的动态模型报损
如图4.1.3-1表明了企业进销存系统中，当库存管理人员增加商品报损单后，增加商品报损单业务逻辑处理相关对象之间的协作。![](pictures/lackList/add.png)
图4.1.4-1增加商品报损单的顺序图
如图4.1.4-2表明了企业进销存系统中，当库存管理人员去除商品报损单后，商品报损单业务逻辑处理相关对象之间的协作。
![](pictures/lackList/delete.png)
图4.1.4-2 删除报损单的顺序图 
如图4.1.4-3表明了企业进销存系统中，当库存管理人更新报损单后，报损单业务逻辑处理相关对象之间的协作。![](pictures/lackList/update.png)
图4.1.4-3 更新报损的顺序图 
如图4.1.4-4表明了企业进销存系统中，当查找报损单，报损单业务逻辑处理相关对象之间的协作。![](pictures/lackList/get.png)
图4.1.4-4 查找报损单的顺序图 
如图4.1.4-4表明了企业进销存系统中，当生成报损单红冲，报损单业务逻辑处理相关对象之间的协作。![](pictures/lackList/addRed.png)
图4.1.4-4 报损单红冲的顺序图 
如图4.1.4-4表明了企业进销存系统中，当查询所有报损单，报损单业务逻辑处理相关对象之间的协作。![](pictures/lackList/getAll.png)
图4.1.4-4 得到所有报损单的顺序图 
如图4.1.1-5描述了lackList对象在生存时的状态序列，在经过并且在结束操作商品分类后结束生命
![](pictures/lackList/lackList_statement.png)
...
![](pictures/lackList/lackList1.png)
