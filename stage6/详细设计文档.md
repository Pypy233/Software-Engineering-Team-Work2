...
<tr>
<tr>
		<th rowspan="3">presentListController.createpresentListList</th>
		<th>语法</th>
		<th>public ArrayList&lt;presentListVO> createpresentListList(String date);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存管理人员选择商品赠送</th>
...
<tr>
		<th rowspan="3">presentListController.submitpresentListOrder</th>
		<th>语法</th>
		<th>public  boolean submitpresentListOrder(String date, ArrayList&lt;presentListVO> presentListLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存管理人员提交商品赠送单</th>
...
<tr>
		<th rowspan="3">presentListController.removeCom</th>
		<th>语法</th>
		<th>public  ResultMessage removeCom(String date, ArrayList&lt;presentListVO> presentListLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
...
<tr>
		<th rowspan="3">presentListController.submitBreakageRecepit</th>
		<th>语法</th>
		<th>public  boolean submitBreakageRecepit(String date, ArrayList&lt;presentListVO> brkLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存报损</th>
...
<tr>
		<th rowspan="3">presentListController.submitOverflowRecepit</th>
		<th>语法</th>
		<th>public  ResultMessage submitOverflowRecepit(String date, ArrayList&lt;presentListVO> overflowLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存报溢</th>
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th> presentListBLService.isInTime(String time);</th>
<th colspan="2">检查库存在预设时间内</th> </tr>
<tr><th>presentListBLService.getComInfo(String date);</th>
<th colspan="2">查询库存</th> </tr>
<tr><th>presentListBLService.getGoods(String goodsNode);
<th colspan="2">获得商品信息</th> </th></tr>
<tr><th>presentListBLService.createpresentListList(String date);</th>
<th colspan="2">创建赠送方案</th> </th></tr>
<tr><th>presentListBLService.removeCom(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">删除赠送商品</th> </tr>
<tr><th>presentListBLService.submitBreakageRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报损单</th> </tr>
<tr><th>presentListBLService.submitOverflowRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报溢单</th> </tr>
<tr><th>presentListBLService.submitWarningRecepit(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报警单</th> </tr>
</table>

表4.1.1-2 presentListBLService类的接口规范
...
<table>
	...
	<tr>
		<th rowspan="3">presentListBLService.InTime</th>
		<th>语法</th>
...
<tr>
		<th rowspan="3">presentListBLService.getComInfo</th>
		<th>语法</th>
		<th>public  ArrayList&lt;presentListVO> getComInfo(String date);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存管理人员查看库存</th>
...
<tr>
		<th rowspan="3">presentListBLService.checkComInfo</th>
		<th>语法</th>
		<th>public  ArrayList&lt;presentListVO> checkComInfo(String date)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>库存管理人员盘点库存</th>
...
<tr>
<tr>
		<th rowspan="3">presentListBLService.createpresentListList</th>
		<th>语法</th>
		<th>public ArrayList&lt;presentListVO> createpresentListList(String date);</th>
		</tr>
		<tr>
...
<tr>
		<th rowspan="3">presentListBLService.submitpresentListOrder</th>
		<th>语法</th>
		<th>public  boolean submitpresentListOrder(String date, ArrayList&lt;presentListVO> presentListLst)</th>
		</tr>
		<tr>
...
<tr>
		<th rowspan="3">presentListBLService.removeCom</th>
		<th>语法</th>
		<th>public  ResultMessage removeCom(String date, ArrayList&lt;presentListVO> presentListLst)</th>
		</tr>
		<tr>
...
<tr>
		<th rowspan="3">presentListBLService.submitBreakageRecepit</th>
		<th>语法</th>
		<th>public  boolean submitBreakageRecepit(String date, ArrayList&lt;presentListVO> brkLst)</th>
		</tr>
		<tr>
...
<tr>
		<th rowspan="3">presentListBLService.submitOverflowRecepit</th>
		<th>语法</th>
		<th>public  ResultMessage submitOverflowRecepit(String date, ArrayList&lt;presentListVO> overflowLst)</th>
		</tr>
		<tr>
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th> presentListDataService.isInTime(String time);</th>
<th colspan="2">检查库存在预设时间内</th> </tr>
<tr><th>presentListDataService.getComInfo(String date);</th>
<th colspan="2">查询库存</th> </tr>
<tr><th>presentListDataService.getGoods(String goodsNode);
<th colspan="2">获得商品信息</th> </th></tr>
<tr><th>presentListDataService.createpresentListList(String date);</th>
<th colspan="2">创建赠送方案</th> </th></tr>
<tr><th>presentListDataService.removeCom(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">删除赠送商品</th> </tr>
<tr><th>presentListDataService.submitBreakageRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报损单</th> </tr>
<tr><th>presentListDataService.submitOverflowRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报溢单</th> </tr>
<tr><th>presentListDataService.submitWarningRecepit(String date, ArrayList &It;presentListPO> lst)</th>
<th colspan="2">提交报警单</th> </tr>
</table>
（4） 业务逻辑层的动态模型


如图4.1.4-2表明了企业进销存系统中，当库存管理人员查看库存后，库存信息业务逻辑处理相关对象之间的协作。![](pictures/presentList/presentList_checkCominfo.png)
图4.1.4-2 查看库存的顺序图 

如图4.1.4-3表明了企业进销存系统中，当库存管理人员增加商品赠送单后，增加商品赠送单业务逻辑处理相关对象之间的协作。![](pictures/presentList/presentList_createPre.png)
图4.1.4-3增加商品赠送单的顺序图 
...
<th colspan="2">删除销售单</th> </th></tr>
<tr><th>SaleDataService.update(SalePO po);</th>
<th colspan="2">修改销售单</th> </tr>
<tr><th>SaleDataService.saleCom(presentListPO po, ArrayList&lt;SalePO> receipt);</th>
<th colspan="2">增加库存</th> </tr>
</table>
...
<tr><th>StockData.stockCom(presentListPO po, ArrayList&lt;StockPO> receipt);</th>
<th colspan="2">增加库存</th> </tr>
</table>
...
<tr>
		<th rowspan="3">SaleProcessRecordVO.getpresentListList</th>
		<th>语法</th>
		<th>public ArrayList&lt;presentListVO> getpresentListList();</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>用户选择查看商品列表</th>
...
##4.2.3presentListData模块
(1）模块概述
presentListData模块承担的需求参见需求规格说明文档功能需求及相关功能需求。
presentListData模块的职责及接口参见软件体系结构描述文档。
<br>（2）整体结构
根据体系结构的设计，采用分层风格，将系统分为展示层，业务逻辑层，数据层。每一层之间为了灵活性，添加了接口，以实现针对接口编程，隔离数据传输的职责，降低层与层之间耦合，添加的接口是presentListDataService 接口。GoodsPO是做为管理信息的持久化对象被添加到设计模型中的。
presentListData模块的设计如图4.2.1-3所示. 
![](pictures/presentList/presentList_data.png)
<br>
<br>
<br>
<table>
...
<table>
	...
	<tr>
		<th rowspan="3">presentListData.isInTime</th>
		<th>语法</th>
		...
		<tr>
		<th rowspan="3">presentListData.exceptionInTime</th>
		<th>语法</th>
...
<tr>
		<th rowspan="3">presentListData.getComInfo</th>
		<th>语法</th>
		<th>public  ArrayList&lt;presentListPO> getComInfo(String date);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>存在此日期的库存信息</th>
...
<tr>
		<th rowspan="3">presentListData.checkCom</th>
		<th>语法</th>
		<th>public  ArrayList&lt;presentListPO> getGoods(String goodsNode)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>存在此日期的库存商品信息</th>
...
<tr>
<tr>
		<th rowspan="3">presentListData.createpresentListList</th>
		<th>语法</th>
		<th>public ArrayList&lt;presentListPO> createpresentListList(String date);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>数据库存在被赠送商品</th>
...
<tr>
		<th rowspan="3">presentListData.submitpresentListList</th>
		<th>语法</th>
		<th>public  boolean submitpresentListOrder(String date, ArrayList&lt;presentListPO> presentListLst);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th数据库提交赠送单</th>
...
<tr>
		<th rowspan="3">presentListData.removeCom</th>
		<th>语法</th>
		<th>public  boolean removeCom(String date, ArrayList&lt;presentListPO> presentListLst);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>数据库存在被赠送商品</th>
...
<tr>
		<th rowspan="3">presentListData.submitBreakageRecepit</th>
		<th>语法</th>
		<th>public  boolean submitBreakageRecepit(String date, ArrayList&lt;presentListPO> brkLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>数据库存在商品量且比实际少</th>
...
<tr>
		<th rowspan="3">presentListData.submitOverflowRecepit</th>
		<th>语法</th>
		<th>public  boolean submitOverflowRecepit(String date, ArrayList&lt;presentListVO> overflowLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>数据库存在商品量且比实际多</th>
...
<tr>
		<th rowspan="3">presentListData.submitWarningRecepit</th>
		<th>语法</th>
		<th>public  boolean submitWarningRecepit(String date, ArrayList&lt;presentListPO> overflowLst)</th>
		</tr>
		<tr>
			<th>前置条件</th>
...
<tr>
		<th rowspan="3">MemberData.update</th>
		<th>语法</th>
		<th>public ResultMessage update(MemberPO po);</th>
		</tr>
		<tr>
...
<tr>
		<th rowspan="3">StockData.update</th>
		<th>语法</th>
		<th>public ResultMessage update(StockPO po);</th>
		</tr>
		<tr>
...
<tr>
        <th rowspan="3">ReturnData.update</th>
        <th>语法</th>
        <th>public ResultMessage update(ReturnPO po);</th>
        </tr>
        <tr>
...
<tr>
        <th rowspan="3">SaleData.update</th>
        <th>语法</th>
        <th>public ResultMessage update(SalePO po);</th>
        </tr>
        <tr>
...
<th colspan="2">删除一个商品分类</th> </th></tr>
<tr><th>ClassfiyController.updateClassify(ClassifyPO po);</th>
<th colspan="2">修改一个商品分类</th> </tr>
...
<th colspan="2">删除一个商品</th> </th></tr>
<tr><th>GoodsController.updateGoods(GoodsPO po);</th>
<th colspan="2">修改一个商品</th> </tr>
<tr><th>GoodsController.findGoods(GoodsPO po);</th>
<th colspan="2">查询一个商品</th> </tr>
</table>

##4.3.2presentListui模块
1）模块概述
 presentListui模块承担的需求参见需求规格说明文档功能需求及相关功能需求。
presentListui模块的职责及接口参见软件体系结构描述文档。<br>
（2）整体结构
为了隔离界面展示职责和逻辑控制职责，我们添加presentListuiController，这样presentListuiController 将会承担库存相关的界面跳转并且调用逻辑层goodsbl、对象的逻辑方法。将presentListVO是做为管理传递和暂时持有的数据对象被添加到设计模型中的。
presentListui模块的设计如图4.3.1-2所示.
![](pictures/presentList/presentList_ui.png)
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th> presentListData.isInTime(String time);</th>
<th colspan="2">检查库存在预设时间内</th> </tr>
<tr><th>presentListData.getComInfo(String date);</th>
<th colspan="2">查询库存</th> </tr>
<tr><th>presentListData.getGoods(String goodsNode);
<th colspan="2">获得商品信息</th> </th></tr>
<tr><th>presentListData.createpresentListList(String date);</th>
<th colspan="2">创建赠送方案</th> </th></tr>
<tr><th>presentListData.removeCom(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">删除赠送商品</th> </tr>
<tr><th>presentListData.submitBreakageRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报损单</th> </tr>
<tr><th>presentListData.submitOverflowRecepit	(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报溢单</th> </tr>
<tr><th>presentListData.submitWarningRecepit(String date, ArrayList&It;presentListPO> lst)</th>
<th colspan="2">提交报警单</th> </tr>
